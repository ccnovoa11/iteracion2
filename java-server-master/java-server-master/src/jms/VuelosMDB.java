...
public class VuelosMDB implements MessageListener, ExceptionListener 
{
	...
	public ListaVuelosMsg getRemoteVuelos(int ) throws JsonGenerationException, JsonMappingException, JMSException, IOException, NonReplyException, InterruptedException, NoSuchAlgorithmException
	{
		answer.clear();
